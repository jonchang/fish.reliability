...
```{r median_tbl, results="asis", anchor="table", fig.cap="Median table"}
med_wide <- meds %>% spread(key=family, value=value)
med_wide %>% knitr::kable(digits = 2, caption = "Median table")
```

```{r mad_tbl, results="asis", anchor="table", fig.cap="MAD table"}
...
```{r turk_morph_procrustes_space, fig.cap="Hello", anchor="figure", message=FALSE}
...
```{r bamm_plots, message=F, warning=F, anchor="figure"}
